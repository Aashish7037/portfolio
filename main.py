...
st.write('##')
st.subheader('I am Aashish Kumar')
...
if selected == 'About':
    with st.container():
        ...
        with col1:
            ...
            st.write("""Welcome to my digital playground, where I sculpt with Python's versatile tools like NumPy and Pandas, create visual symphonies using Matplotlib, and build dynamic experiences with PHP. HTML, CSS, React, Node, MySQL, and MongoDB are my chosen palettes. Explore my portfolio—a showcase of seamless fusion between creativity and cutting-edge technology..""")
            st.write("----------")
            ...
            st.code(
                """
                'Python🐍   SQL🐬   C++🖥️   HTML🌐'
                'Numpy🧮   Pandas🐼   Matplotlib📈   CSS🎨'
                'DSA📚   OOPs🧪   Git🐙   Github🐙'
                'Streamlit🔮   Django🌐   React⚛️   Node.js🚀'
                'Machine Learning 🤖   Backend Developer💼   RestApi🌐'
        ...
        with col2:
            with col2:
                ...
                st.markdown("- [Leetcode](https://leetcode.com/aashishchoudhary9760/)")
                #st.markdown("- [CodeChef](https://www.codechef.com/users/vipuldhankar17)")
                st.markdown("- [Hackerrank](https://www.hackerrank.com/profile/aashishchoudhar4)")
                #st.markdown(
        ...
        with st.container():
            ...
            with col3:
                ...
                education_df = pd.DataFrame({
                    ...
                    'Grade': ['8.39 CGPA', '61.12%', '69.12%'],
                    'Board': ['SRMIST', 'CBSE', 'CBSE']
                })
    ...
    with col1:
        with st.container():
            selected = option_menu(
                ...
                options=['Python', 'DSA', 'Mysql Beginner', 'MySql Intermediate', 'Problem Solving Basic Certificate',
                         'Problem Solving Intermediate Certificate', 'Data Analysis', 'Pandas'],
                icons=['code-square', 'code-square', 'code-square', 'code-square', 'code-square', 'code-square',
                       'code-square', 'code-square', 'code-square'],
            )
        ...
        if selected == 'Python':
            with col2:
                ...
                st.markdown(
                    '------------------------------------------------------------------------------------------Verify at : [link](https://ninjasfiles.s3.amazonaws.com/certificate275017976f6c891eb495cdbfa5db8745b992116.pdf)')

        if selected == 'DSA':
            with col2:
                st.image('NPTEL DSA_page-0001.jpg', caption='NPTEL Certificate')
                st.markdown(
                    '------------------------------------------------------------------------------------------Verify at : [link](https://drive.google.com/file/d/1m7J5pY9VGkKaS6RUgXlBg-MbEjPPlrCN/view)')
        ...
        if selected == 'Mysql Beginner':
            with col2:
                ...
                st.markdown(
                    '------------------------------------------------------------------------------------------Verify at : [link](https://www.hackerrank.com/certificates/4fefbc6b8162)')
        ...
        if selected == 'MySql Intermediate':
            with col2:
                ...
                st.markdown(
                    '------------------------------------------------------------------------------------------Verify at : [link](https://www.hackerrank.com/certificates/7781b740714d)')

        if selected == 'Problem Solving Basic Certificate':
            with col2:
                st.image('problem_solving_basic certificate_page-0001.jpg',
                         caption="Vipul Kumar's HackerRank Certificates")
                st.markdown(
                    '------------------------------------------------------------------------------------------Verify at : [link](https://www.hackerrank.com/certificates/0d2f352f87e0)')

        if selected == 'Problem Solving Intermediate Certificate':
            with col2:
                st.image('problem_solving_intermediate certificate_page-0001.jpg',
                         caption="Vipul Kumar's HackerRank Certificates")
                st.markdown(
                    '------------------------------------------------------------------------------------------Verify at : [link](https://www.hackerrank.com/certificates/bb46e0b2d12d)')
...
if selected == 'project':
    ...
    if selected == 'My Porfolio Website':
        with col2:
            ...
            st.write(
                "- 🚀 As a developer, I've harnessed the power of Streamlit to create my own dynamic portfolio website. 🌐")
            st.write(
                "- 💼 On my site, you'll find a collection of my projects and experience neatly organized for easy navigation. Explore my Projects section to see my work in action.")
        ...
        with col35:
            st.write(
                "- 🎓 I'm committed to lifelong learning and have earned several certificates in the tech industry. Head over to my Certificates section to see my qualifications.")
            st.write(
                "- 📈 With interactive charts and visuals, I've made it simpler for visitors to understand my work and skills.")

            st.write("- 👉 [Check it out here](https://mainpy-kvjdrm8gh65vqodkzoueyb.streamlit.app/).")

            st.write(
                "- 🤝 I'm always looking to connect with fellow professionals, so please feel free to send me a connection request.")
    ...
    if selected == 'Inshort News Clone':
        with col2:
            ...
            boxes.create_skill_buttons(stack)
            st.write(
                "I'm a Python developer who created 'Mera News App,' a user-friendly news application. It provides real-time news updates with images, headlines, and descriptions. Stay informed and explore the world's latest news with ease")
    ...
    if selected == 'IPL RestAPI':
        with col2:
            ...
            stack = ['Flask', 'Python', 'Pandas', 'Numpy', 'Data Analysis', 'MySQL', 'API Development', 'Backened Dev',
                     'API Testing']
            boxes.create_skill_buttons(stack)
            st.write(
                'Introducing 12TH MAN IPL API Service—a treasure trove of cricket data! You can use my API to build your fantastic app, enhance your cricket website, or simply explore cricket data.')
    ...
    if selected == 'Using Tableau':
        with col2:
            ...
            st.write(
                '📊 Explore the IPL like never before! My Tableau IPL data project is now live, offering dynamic data trends at your fingertips. Dive into cricket insights with the power to choose.')
            st.markdown(
        ...
        with col4:
            ...
            st.markdown(
                '- [Video Link To see Project](https://www.loom.com/share/da892138440f4cb7aa108ba68915710e?sid=dd779a16-8a6e-46d9-9cd6-dad64564ec3c)')
